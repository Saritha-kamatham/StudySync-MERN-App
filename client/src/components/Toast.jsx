...
const Toast = ({ message, type = 'info', duration = 4000, onClose }) => {
  ...
  const getToastStyles = () => {
    const baseStyles = 'fixed top-4 right-4 max-w-sm p-4 rounded-lg shadow-lg z-50 transition-all duration-300 ease-in-out';
    ...
    switch (type) {
      ...
      case 'warning':
        return `${baseStyles} ${animationStyles} bg-yellow-500 text-white`;
      default:
